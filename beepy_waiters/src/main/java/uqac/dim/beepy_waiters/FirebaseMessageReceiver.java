...
public class FirebaseMessageReceiver extends FirebaseMessagingService
{
    ...
    public void test()
    {
        ...
        Message m = Message
        Notification.MessagingStyle.Message m = NotificationCompat.MessagingStyle.Message.builder()
    ...
    private RemoteViews getCustomDesign(String title,
        ...
        remoteViews.setImageViewResource(R.id.icon,
                R.mipmap.beepy_icon_foreground);
        return remoteViews;
    }
    ...
    public void showNotification(String title,
        ...
        NotificationCompat.Builder builder
                ...
                channel_id)
                .setSmallIcon(R.mipmap.beepy_icon_foreground)
                .setAutoCancel(true)
